...
export default function RoomDetailPage({ params }: RoomPageProps) {
  ...
  const roomImages =
    room?.imgs && room.imgs.length > 0 ? room.imgs : room ? [room.img] : [];
  ...
  return (
    <section className="px-10 py-32 max-w-4xl mx-auto">
      <div className="bg-white rounded-3xl shadow-2xl p-8">
        ...
        {/* Room info */}
        <h2 className="text-4xl font-serif font-bold mb-4 text-black">{room.name}</h2>
        ...
        <div className="mb-6 mt-6">
          <h3 className="text-2xl font-semibold mb-2 text-black">รายละเอียด</h3>
        ...
        {/* สิ่งอำนวยความสะดวก */}
        <div className="mb-6">
          <h3 className="text-2xl font-semibold mb-2 text-black">สิ่งอำนวยความสะดวก</h3>
          <ul className="list-disc list-inside space-y-1 text-gray-700">
        ...
        {/* ราคา */}
        <div className="mb-6">
          <h3 className="text-2xl font-semibold mb-2 text-black">ราคา</h3>
          <ul className="list-disc list-inside space-y-1 text-gray-700">
        ...
        <div className="flex justify-between space-x-4 mt-6">
          {room.available ? (
            <Link
              ...
              className="flex-1"
            >
              <button className="w-full py-3 rounded-lg bg-blue-600 hover:bg-blue-700 transition font-semibold text-white">
                จองห้อง
              </button>
            </Link>
          ) : (
          ...
          <Link href="/rooms" className="flex-1">
            <button className="w-full py-3 rounded-lg bg-gray-700 hover:bg-gray-600 transition font-semibold text-white">
