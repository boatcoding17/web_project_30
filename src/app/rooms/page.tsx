...
export default function RoomsPage() {
  ...
  return (
    <section className="px-10 py-32 text-white min-h-screen">
      <h2 className="text-5xl font-serif font-bold text-center mb-16 text-primary-gold text-[var(--accent)]">
  ...
  {rooms.map((room) => (
    <Link href={`/rooms/${room.slug}`} key={room.id}>
      <div className="bg-gradient-to-b from-black to-gray-900 rounded-2xl shadow-2xl overflow-hidden cursor-pointer group border border-transparent flex flex-col h-full">
        ...
        {/* Content */}
        <div className="p-8 text-center flex flex-col flex-1 justify-between">
          <div>
