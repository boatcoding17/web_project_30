          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
            ...
            <header className="flex justify-between items-center px-12 py-5 backdrop-blur-md shadow-xl fixed top-0 left-0 right-0 z-50">
              ...
              <nav className="hidden md:flex gap-10 text-sm font-medium uppercase">
                ...
                <Link href="/rooms" className="transition hover:underline">Rooms</Link>
                <Link href="/booking" className="transition hover:underline">Booking</Link>
                <Link href="/confirm" className="transition hover:underline">Confirm</Link>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <Link href="/offers" className="transition hover:underline underline-offset-2">Exclusive Offers</Link>
                <Link href="/gallery" className="transition hover:underline underline-offset-2">Gallery</Link>
                <Link href="/weddings" className="transition hover:underline underline-offset-2">Weddings</Link>
              </ul>
            </div>
